      ...
      <div class="container">
        ...
        <div class="section-roadmap__top-block__question">
          ...
          <h3 class="section-roadmap__top-block__question__text">
            Did you ever ask yourself, where should i put my funds today to get the best returns?
          </h3>
        </div>
            <div class="section-roadmap__top-block__swipe-right">
              <span class="section-roadmap__top-block__swipe-right__text">swipe right</span>
              <ui-btn>
        ...
        <div class="section-roadmap__slider">
          <div class="section-roadmap__slider-wrapper swiper">
            ...
            >
              <div
v-for="(item,indx) in sliderItems" :key="indx"
class="swiper-slide"
                :class="`slide--${indx}`"
              >
              ...
              <div class="section-roadmap__slider-item__top">
                <div class="section-roadmap__slider-item__top-quarter">
                  <div class="section-roadmap__slider-item__top-quarter__number stroked">
                    <h3>{{ item.q }}</h3>
                    <span>{{ item.numb }}</span>
                  </div>
...
v-for="(point,index) in item.points"
                  ...
                  >
                    <div class="section-roadmap__slider-item__bottom-list-item__img">
                      <img src="img/check.png" alt="">
                    </div>
                    <p class="section-roadmap__slider-item__bottom-list-item__text">
                      {{ point }}
                    </p>
                  </div>
                </div>
...
<style lang="scss" scoped>
  ...
  .section-roadmap {
    position: relative;
    background: radial-gradient(144.34% 505.62% at -64.89% 180.52%, rgba(40, 45, 173, 0.154) 0%, rgba(15, 15, 55, 0.55) 100%);
    &__top-block {
      display: flex;
      align-items: center;
      position: relative;
    ...
    &__slider {
      ...
      &-item {
        background:
        linear-gradient(226.76deg, rgba(255, 162, 223, 0.08) -4.53%, rgba(105, 159, 255, 0.08) 46.5%);
